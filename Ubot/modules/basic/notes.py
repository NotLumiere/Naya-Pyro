...
add_command_help(
    "notes",
    [
        [f" save [text/reply]", "Simpan pesan ke Group. (bisa menggunakan stiker)"],
        [f" get [nama]", "Ambil catatan ke tersimpan"],
        [f" notes", "Lihat Daftar Catatan"],
        [f" rm [nama]", "Menghapus nama catatan"],
    ],
)
